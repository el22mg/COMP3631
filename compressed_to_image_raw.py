...
class CompressedImageConverter(Node):
    def __init__(self):
        ...
        self.subscription = self.create_subscription(CompressedImage, '/camera/image/compressed', callback=self.image_callback, 10)
    ...
    def image_callback(self, msg):
        ...
        try:
            ...
            # to the method.
            cvImage = self.bridge.compressed_imgmsg_to_cv2(msg)
            ...
            imageMessage = self.bridge.cv2_to_imgmsg(cvImage, 'bgr8')
